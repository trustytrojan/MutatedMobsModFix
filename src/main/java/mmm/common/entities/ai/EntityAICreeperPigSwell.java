...
public class EntityAICreeperPigSwell extends EntityAIBase
{
    EntityCreeperPig swellingCreeper;
    EntityLivingBase creeperAttackTarget;
    
    public EntityAICreeperPigSwell(final EntityCreeperPig EntityCreeperPigIn) {
        this.swellingCreeper = EntityCreeperPigIn;
        this.setMutexBits(1);
    }
