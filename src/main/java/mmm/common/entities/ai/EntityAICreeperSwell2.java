...
public class EntityAICreeperSwell2 extends EntityAIBase
{
    EntitySilverfishCreeper swellingCreeper;
    EntityLivingBase creeperAttackTarget;
    
    public EntityAICreeperSwell2(final EntitySilverfishCreeper EntitySilverfishCreeperIn) {
        this.swellingCreeper = EntitySilverfishCreeperIn;
        this.setMutexBits(1);
    }
