...
public class EntityAICreeperSwell3 extends EntityAIBase
{
    EntitySlimeCreeper swellingCreeper;
    EntityLivingBase creeperAttackTarget;
    
    public EntityAICreeperSwell3(final EntitySlimeCreeper EntitySlimeCreeperIn) {
        this.swellingCreeper = EntitySlimeCreeperIn;
        this.setMutexBits(1);
    }
