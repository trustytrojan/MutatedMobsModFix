...
public class EntityAICreeperSwell4 extends EntityAIBase
{
    EntitySpiderCreeper swellingCreeper;
    EntityLivingBase creeperAttackTarget;
    
    public EntityAICreeperSwell4(final EntitySpiderCreeper EntitySpiderCreeperIn) {
        this.swellingCreeper = EntitySpiderCreeperIn;
        this.setMutexBits(1);
    }
