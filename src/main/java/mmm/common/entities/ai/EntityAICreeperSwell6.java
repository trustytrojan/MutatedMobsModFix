...
public class EntityAICreeperSwell6 extends EntityAIBase
{
    EntityZombieCreeper swellingCreeper;
    EntityLivingBase creeperAttackTarget;
    
    public EntityAICreeperSwell6(final EntityZombieCreeper EntityZombieCreeperIn) {
        this.swellingCreeper = EntityZombieCreeperIn;
        this.setMutexBits(1);
    }
