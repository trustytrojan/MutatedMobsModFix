...
public class EntityAICreeperSwell7 extends EntityAIBase
{
    EntityCreeperGolem swellingCreeper;
    EntityLivingBase creeperAttackTarget;
    
    public EntityAICreeperSwell7(final EntityCreeperGolem EntityCreeperGolemIn) {
        this.swellingCreeper = EntityCreeperGolemIn;
        this.setMutexBits(1);
    }
