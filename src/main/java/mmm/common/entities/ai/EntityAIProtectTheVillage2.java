...
public class EntityAIProtectTheVillage2 extends EntityAITarget
{
    EntitySlimeGolem irongolem;
    EntityLivingBase villageAgressorTarget;
    
    public EntityAIProtectTheVillage2(final EntitySlimeGolem ironGolemIn) {
