...
public class EntityAIProtectTheVillage3 extends EntityAITarget
{
    EntityCreeperGolem irongolem;
    EntityLivingBase villageAgressorTarget;
    
    public EntityAIProtectTheVillage3(final EntityCreeperGolem ironGolemIn) {
