...
public class EntityBlazeGolem extends EntityGolem implements IMutant
{
    ...
    protected void initEntityAI() {
        ...
        this.targetTasks.addTask(1, (EntityAIBase)new EntityAIProtectTheVillage4(this));
    ...
    protected void entityInit() {
        super.entityInit();
        this.dataManager.register((DataParameter)EntityBlazeGolem.PLAYER_CREATED, (Object)0);
    }
    ...
    public static void registerFixesIronGolem(final DataFixer fixer) {
        EntityLiving.registerFixesMob(fixer, (Class)EntityBlazeGolem.class);
    }
    ...
    public boolean isPlayerCreated() {
        return ((byte)this.dataManager.get((DataParameter)EntityBlazeGolem.PLAYER_CREATED) & 0x1) != 0x0;
    }
    
    public void setPlayerCreated(final boolean playerCreated) {
        final byte b0 = (byte)this.dataManager.get((DataParameter)EntityBlazeGolem.PLAYER_CREATED);
        if (playerCreated) {
            this.dataManager.set((DataParameter)EntityBlazeGolem.PLAYER_CREATED, (Object)(byte)(b0 | 0x1));
        }
        else {
            this.dataManager.set((DataParameter)EntityBlazeGolem.PLAYER_CREATED, (Object)(byte)(b0 & 0xFFFFFFFE));
        }
    }
    ...
    static {
        PLAYER_CREATED = EntityDataManager.createKey((Class)EntityBlazeGolem.class, DataSerializers.BYTE);
    }
}
