...
public class EntityDeadPolarWolf extends EntityMob implements IMutant
{
    ...
    protected void applyEntityAI() {
        ...
        this.targetTasks.addTask(3, (EntityAIBase)new EntityAINearestAttackableTarget((EntityCreature)this, (Class)EntityPolarWolf.class, true));
        this.targetTasks.addTask(3, (EntityAIBase)new EntityAINearestAttackableTarget((EntityCreature)this, (Class)EntityTameable.class, true));
