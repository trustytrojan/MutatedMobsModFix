...
public class EntitySpiderGuardian extends EntityMob implements IMutant
{
    ...
    protected void entityInit() {
        ...
        this.dataManager.register(EntitySpiderGuardian.CLIMBING, false);
    }
    ...
    public void setBesideClimbableBlock(final boolean climbing) {
        this.dataManager.set(EntitySpiderGuardian.CLIMBING, climbing);
    }
    ...
    public boolean isBesideClimbableBlock() {
        return (boolean)this.dataManager.get(EntitySpiderGuardian.CLIMBING);
    }
    ...
    static {
        CLIMBING = EntityDataManager.createKey(EntitySpiderGuardian.class, DataSerializers.BOOLEAN);
