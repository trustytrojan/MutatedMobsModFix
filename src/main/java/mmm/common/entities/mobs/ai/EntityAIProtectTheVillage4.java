...
public class EntityAIProtectTheVillage4 extends EntityAITarget
{
    EntityBlazeGolem irongolem;
    EntityLivingBase villageAgressorTarget;
    
    public EntityAIProtectTheVillage4(final EntityBlazeGolem ironGolemIn) {
