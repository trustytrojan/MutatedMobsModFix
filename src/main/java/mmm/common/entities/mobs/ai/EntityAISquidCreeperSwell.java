...
public class EntityAISquidCreeperSwell extends EntityAIBase
{
    EntitySquidCreeper swellingCreeper;
    EntityLivingBase creeperAttackTarget;
    
    public EntityAISquidCreeperSwell(final EntitySquidCreeper EntitySquidCreeperIn) {
        this.swellingCreeper = EntitySquidCreeperIn;
        this.setMutexBits(1);
    }
