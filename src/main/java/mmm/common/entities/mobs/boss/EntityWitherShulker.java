...
public class EntityWitherShulker extends EntityMob implements IBoss, IMutant
{
    ...
    public EntityWitherShulker(final World worldIn) {
        super(worldIn);
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue((double)ConfigHandler.HP_WitherShulker);
        this.getEntityAttribute(SharedMonsterAttributes.FOLLOW_RANGE).setBaseValue(300.0);
    }
    ...
    public void updateArmorModifier(final int p_184691_1_) {
        if (!this.world.isRemote) {
            this.getEntityAttribute(SharedMonsterAttributes.ARMOR).removeModifier(EntityWitherShulker.COVERED_ARMOR_BONUS_MODIFIER);
            if (p_184691_1_ == 0) {
                this.getEntityAttribute(SharedMonsterAttributes.ARMOR).applyModifier(EntityWitherShulker.COVERED_ARMOR_BONUS_MODIFIER);
    ...
    class AIAttack extends EntityAIBase
    {
        ...
        public boolean shouldExecute() {
            ...
            return entitylivingbase != null && entitylivingbase.isEntityAlive() && EntityWitherShulker.this.world.getDifficulty() != EnumDifficulty.PEACEFUL;
        }
        
        public void startExecuting() {
            this.attackTime = 10;
            EntityWitherShulker.this.updateArmorModifier(100);
        }
        
        public void resetTask() {
            EntityWitherShulker.this.updateArmorModifier(0);
        }
        ...
        public void updateTask() {
            if (EntityWitherShulker.this.world.getDifficulty() != EnumDifficulty.PEACEFUL) {
                ...
                if (d0 < 400.0) {
                    ...
                    EntityWitherShulker.this.setAttackTarget((EntityLivingBase)null);
                }
                super.updateTask();
            }
        }
    ...
    class AIAttackNearest extends EntityAINearestAttackableTarget<EntityPlayer>
    {
        ...
        public boolean shouldExecute() {
            return EntityWitherShulker.this.world.getDifficulty() != EnumDifficulty.PEACEFUL && super.shouldExecute();
        }
        
        protected AxisAlignedBB getTargetableArea(final double targetDistance) {
            final EnumFacing enumfacing = ((EntityWitherShulker)this.taskOwner).getAttachmentFacing();
    ...
    class AIPeek extends EntityAIBase
    {
        ...
        public boolean shouldExecute() {
            return EntityWitherShulker.this.getAttackTarget() == null && EntityWitherShulker.this.rand.nextInt(40) == 0;
        }
        
        public boolean shouldContinueExecuting() {
            return EntityWitherShulker.this.getAttackTarget() == null && this.peekTime > 0;
        }
        
        public void startExecuting() {
            this.peekTime = 20 * (1 + EntityWitherShulker.this.rand.nextInt(3));
            EntityWitherShulker.this.updateArmorModifier(30);
        }
        
        public void resetTask() {
            if (EntityWitherShulker.this.getAttackTarget() == null) {
                EntityWitherShulker.this.updateArmorModifier(0);
            }
        }
