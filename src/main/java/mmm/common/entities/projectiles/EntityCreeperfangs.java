...
public class EntityCreeperfangs extends Entity
{
    ...
    public EntityCreeperfangs(final World worldIn) {
        super(worldIn);
        this.lifeTicks = 22;
        this.setSize(0.5f, 0.8f);
    }
    
    public EntityCreeperfangs(final World worldIn, final double x, final double y, final double z, final float p_i47276_8_, final int p_i47276_9_, final EntityLivingBase casterIn) {
        this(worldIn);
    ...
    public void onUpdate() {
        ...
        if (this.world.isRemote) {
            ...
            if (this.warmupDelayTicks == -8) {
                for (final EntityLivingBase entitylivingbase : this.world.getEntitiesWithinAABB(EntityLivingBase.class, this.getEntityBoundingBox().grow(0.2, 0.0, 0.2))) {
