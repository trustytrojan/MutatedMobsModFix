...
public class EntityWitherBullet extends Entity
{
    ...
    public EntityWitherBullet(final World worldIn) {
        super(worldIn);
    ...
    public EntityWitherBullet(final World worldIn, final double x, final double y, final double z, final double motionXIn, final double motionYIn, final double motionZIn) {
        this(worldIn);
    ...
    public EntityWitherBullet(final World worldIn, final EntityLivingBase ownerIn, final Entity targetIn, final EnumFacing.Axis p_i46772_4_) {
        this(worldIn);
        this.owner = ownerIn;
