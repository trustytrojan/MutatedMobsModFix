...
public class ItemEmeraldMobFuser extends Item
{
    ...
    public ItemEmeraldMobFuser(final String unlocalizedName) {
        this.setCreativeTab(CreativeTabs.MISC);
        this.setUnlocalizedName(unlocalizedName);
        this.setMaxDamage(1040);
    }
    ...
    public void SpawnMutant(final World world, final EntityPlayer playerIn) {
        if (this.marked instanceof EntityCreeper && this.marked2 instanceof EntitySpider && !world.isRemote) {
            ...
            this.marked = null;
            this.marked2 = null;
            world.playSound((EntityPlayer)null, playerIn.posX, playerIn.posY, playerIn.posZ, SoundEvents.ITEM_TOTEM_USE, SoundCategory.NEUTRAL, 0.5f, 0.4f / (ItemEmeraldMobFuser.itemRand.nextFloat() * 0.4f + 0.8f));
        }
