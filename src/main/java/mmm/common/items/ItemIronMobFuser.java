...
public class ItemIronMobFuser extends Item
{
    public EntityLivingBase marked;
    public EntityLivingBase marked2;
    
    public ItemIronMobFuser(final String unlocalizedName) {
    ...
    public ActionResult<ItemStack> onItemRightClick(final World worldIn, final EntityPlayer playerIn, final EnumHand handIn) {
        ...
        if (this.marked != null && this.marked2 != null && this.marked.isPotionActive(MobEffects.WEAKNESS)) {
