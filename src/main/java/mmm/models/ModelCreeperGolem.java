...
public class ModelCreeperGolem extends ModelBase
{
    ...
    public ModelCreeperGolem() {
        this(0.0f);
    }
    
    public ModelCreeperGolem(final float p_i1161_1_) {
        this(p_i1161_1_, -7.0f);
    }
    
    public ModelCreeperGolem(final float p_i46362_1_, final float p_i46362_2_) {
        final int i = 128;
        final int j = 128;
        (this.ironGolemHead = new ModelRenderer((ModelBase)this).setTextureSize(128, 128)).setRotationPoint(0.0f, 0.0f + p_i46362_2_, -2.0f);
        ...
        (this.ironGolemBody = new ModelRenderer((ModelBase)this).setTextureSize(128, 128)).setRotationPoint(0.0f, 0.0f + p_i46362_2_, 0.0f);
        ...
        (this.ironGolemRightArm = new ModelRenderer((ModelBase)this).setTextureSize(128, 128)).setRotationPoint(0.0f, -7.0f, 0.0f);
        this.ironGolemRightArm.setTextureOffset(60, 21).addBox(-13.0f, -2.5f, -3.0f, 4, 30, 6, p_i46362_1_);
        (this.ironGolemLeftArm = new ModelRenderer((ModelBase)this).setTextureSize(128, 128)).setRotationPoint(0.0f, -7.0f, 0.0f);
        this.ironGolemLeftArm.setTextureOffset(60, 58).addBox(9.0f, -2.5f, -3.0f, 4, 30, 6, p_i46362_1_);
        (this.ironGolemLeftLeg = new ModelRenderer((ModelBase)this, 0, 22).setTextureSize(128, 128)).setRotationPoint(-4.0f, 18.0f + p_i46362_2_, 0.0f);
        this.ironGolemLeftLeg.setTextureOffset(37, 0).addBox(-3.5f, -3.0f, -3.0f, 6, 16, 5, p_i46362_1_);
        this.ironGolemRightLeg = new ModelRenderer((ModelBase)this, 0, 22).setTextureSize(128, 128);
    ...
    public void setLivingAnimations(final EntityLivingBase entitylivingbaseIn, final float limbSwing, final float limbSwingAmount, final float partialTickTime) {
        final EntityCreeperGolem EntityCreeperGolem = (EntityCreeperGolem)entitylivingbaseIn;
        final int i = EntityCreeperGolem.getAttackTimer();
        if (i > 0) {
            ...
            final int j = EntityCreeperGolem.getHoldRoseTick();
            if (j > 0) {
