...
public class ModelCustomIllager extends ModelBase
{
    ...
    public ModelCustomIllager(final float scaleFactor, final float p_i47227_2_, final int textureWidthIn, final int textureHeightIn) {
        (this.head = new ModelRenderer((ModelBase)this).setTextureSize(textureWidthIn, textureHeightIn)).setRotationPoint(0.0f, 0.0f + p_i47227_2_, 0.0f);
        this.head.setTextureOffset(0, 0).addBox(-4.0f, -10.0f, -4.0f, 8, 10, 8, scaleFactor);
        (this.hat = new ModelRenderer((ModelBase)this, 32, 0).setTextureSize(textureWidthIn, textureHeightIn)).addBox(-4.0f, -10.0f, -4.0f, 8, 12, 8, scaleFactor + 0.45f);
        this.head.addChild(this.hat);
        this.hat.showModel = false;
        (this.nose = new ModelRenderer((ModelBase)this).setTextureSize(textureWidthIn, textureHeightIn)).setRotationPoint(0.0f, p_i47227_2_ - 2.0f, 0.0f);
        this.nose.setTextureOffset(24, 0).addBox(-1.0f, -1.0f, -6.0f, 2, 4, 2, scaleFactor);
        this.head.addChild(this.nose);
        (this.body = new ModelRenderer((ModelBase)this).setTextureSize(textureWidthIn, textureHeightIn)).setRotationPoint(0.0f, 0.0f + p_i47227_2_, 0.0f);
        ...
        (this.arms = new ModelRenderer((ModelBase)this).setTextureSize(textureWidthIn, textureHeightIn)).setRotationPoint(0.0f, 0.0f + p_i47227_2_ + 2.0f, 0.0f);
        this.arms.setTextureOffset(44, 22).addBox(-8.0f, -2.0f, -2.0f, 4, 8, 4, scaleFactor);
        final ModelRenderer modelrenderer = new ModelRenderer((ModelBase)this, 44, 22).setTextureSize(textureWidthIn, textureHeightIn);
        ...
        (this.leg0 = new ModelRenderer((ModelBase)this, 0, 22).setTextureSize(textureWidthIn, textureHeightIn)).setRotationPoint(-2.0f, 12.0f + p_i47227_2_, 0.0f);
        this.leg0.addBox(-2.0f, 0.0f, -2.0f, 4, 12, 4, scaleFactor);
        this.leg1 = new ModelRenderer((ModelBase)this, 0, 22).setTextureSize(textureWidthIn, textureHeightIn);
        this.leg1.mirror = true;
        this.leg1.setRotationPoint(2.0f, 12.0f + p_i47227_2_, 0.0f);
        this.leg1.addBox(-2.0f, 0.0f, -2.0f, 4, 12, 4, scaleFactor);
        (this.rightArm = new ModelRenderer((ModelBase)this, 40, 46).setTextureSize(textureWidthIn, textureHeightIn)).addBox(-3.0f, -2.0f, -2.0f, 4, 12, 4, scaleFactor);
        this.rightArm.setRotationPoint(-5.0f, 2.0f + p_i47227_2_, 0.0f);
        this.leftArm = new ModelRenderer((ModelBase)this, 40, 46).setTextureSize(textureWidthIn, textureHeightIn);
    ...
    public void render(final Entity entityIn, final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch, final float scale) {
        ...
        final AbstractCustomIllager abstractillager = (AbstractCustomIllager)entityIn;
        if (abstractillager.getArmPose() == AbstractCustomIllager.IllagerArmPose.CROSSED) {
    ...
    public void setRotationAngles(final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch, final float scaleFactor, final Entity entityIn) {
        ...
        final AbstractCustomIllager.IllagerArmPose abstractillager$illagerarmpose = ((AbstractCustomIllager)entityIn).getArmPose();
        if (abstractillager$illagerarmpose == AbstractCustomIllager.IllagerArmPose.ATTACKING) {
        ...
        else if (abstractillager$illagerarmpose == AbstractCustomIllager.IllagerArmPose.SPELLCASTING) {
        ...
        else if (abstractillager$illagerarmpose == AbstractCustomIllager.IllagerArmPose.BOW_AND_ARROW) {
