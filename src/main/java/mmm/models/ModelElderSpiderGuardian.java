...
public class ModelElderSpiderGuardian extends ModelBase
{
    ...
    public ModelElderSpiderGuardian() {
    ...
    public void setRotationAngles(final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch, final float scaleFactor, final Entity entityIn) {
        final EntityElderSpiderGuardian EntityElderElderSpiderGuardian = (EntityElderSpiderGuardian)entityIn;
        final float f = ageInTicks - EntityElderElderSpiderGuardian.ticksExisted;
        ...
        final float f2 = (1.0f - EntityElderElderSpiderGuardian.getSpikesAnimation(f)) * 0.55f;
        for (int i = 0; i < 12; ++i) {
