...
public class ModelGuardianGolem extends ModelBase
{
    ...
    public ModelGuardianGolem(final float p_i1161_1_) {
        this(p_i1161_1_, -7.0f);
    }
    
    public ModelGuardianGolem(final float p_i46362_1_, final float p_i46362_2_) {
        final int i = 128;
        final int j = 128;
    ...
    public void setLivingAnimations(final EntityLivingBase entitylivingbaseIn, final float limbSwing, final float limbSwingAmount, final float partialTickTime) {
        final EntityGuardianGolem EntityGuardianGolem = (EntityGuardianGolem)entitylivingbaseIn;
        final int i = EntityGuardianGolem.getAttackTimer();
        if (i > 0) {
            ...
            final int j = EntityGuardianGolem.getHoldRoseTick();
            if (j > 0) {
