...
public class ModelIWitherSkeleton extends ModelBiped
{
    public ModelIWitherSkeleton() {
        this(0.0f, false);
    }
    
    public ModelIWitherSkeleton(final float modelSize, final boolean p_i46303_2_) {
    ...
    public void setLivingAnimations(final EntityLivingBase entitylivingbaseIn, final float limbSwing, final float limbSwingAmount, final float partialTickTime) {
        ...
        if (itemstack.getItem() == Items.BOW && ((EntityIlliusionerWitherSkeleton)entitylivingbaseIn).isSwingingArms()) {
    ...
    public void setRotationAngles(final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch, final float scaleFactor, final Entity entityIn) {
        ...
        final EntityIlliusionerWitherSkeleton AbstractBabySkeleton = (EntityIlliusionerWitherSkeleton)entityIn;
