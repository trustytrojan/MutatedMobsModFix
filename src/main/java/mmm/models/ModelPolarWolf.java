...
public class ModelPolarWolf extends ModelBase
{
    ...
    public ModelPolarWolf() {
        ...
        (this.Body = new ModelRenderer((ModelBase)this, 15, 31)).addBox(-4.0f, -2.0f, -3.0f, 12, 18, 12);
        this.Body.setRotationPoint(-1.0f, 14.0f, -3.0f);
        this.Body.setTextureSize(64, 64);
        this.Body.mirror = true;
        this.setRotation(this.Body, 1.570796f, 0.0f, 0.0f);
        (this.Mane = new ModelRenderer((ModelBase)this, 33, 0)).addBox(-4.0f, -3.0f, -3.0f, 8, 6, 7);
        ...
        (this.Leg1 = new ModelRenderer((ModelBase)this, 1, 52)).addBox(-1.0f, 0.0f, -1.0f, 3, 7, 2);
        this.Leg1.setRotationPoint(-3.5f, 17.0f, 10.0f);
        this.Leg1.setTextureSize(64, 64);
        this.Leg1.mirror = true;
        this.setRotation(this.Leg1, 0.0f, 0.0f, 0.0f);
        (this.Leg2 = new ModelRenderer((ModelBase)this, 1, 52)).addBox(-1.0f, 0.0f, -1.0f, 3, 7, 2);
        this.Leg2.setRotationPoint(3.5f, 17.0f, 10.0f);
        this.Leg2.setTextureSize(64, 64);
        this.Leg2.mirror = true;
        this.setRotation(this.Leg2, 0.0f, 0.0f, 0.0f);
        (this.Leg3 = new ModelRenderer((ModelBase)this, 1, 52)).addBox(-1.0f, 0.0f, -1.0f, 3, 7, 2);
        this.Leg3.setRotationPoint(-2.5f, 17.0f, -4.0f);
        this.Leg3.setTextureSize(64, 64);
        this.Leg3.mirror = true;
        this.setRotation(this.Leg3, 0.0f, 0.0f, 0.0f);
        (this.Leg4 = new ModelRenderer((ModelBase)this, 1, 52)).addBox(-1.0f, 0.0f, -1.0f, 3, 7, 2);
        this.Leg4.setRotationPoint(3.5f, 17.0f, -4.0f);
        this.Leg4.setTextureSize(64, 64);
        this.Leg4.mirror = true;
        this.setRotation(this.Leg4, 0.0f, 0.0f, 0.0f);
        (this.Tail = new ModelRenderer((ModelBase)this, 9, 18)).addBox(-1.0f, 0.0f, -1.0f, 3, 8, 3);
