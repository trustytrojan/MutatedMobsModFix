...
public class ModelSlimeGolem extends ModelBase
{
    ...
    public ModelSlimeGolem() {
        this(0.0f);
    }
    
    public ModelSlimeGolem(final float p_i1161_1_) {
        this(p_i1161_1_, -7.0f);
    }
    
    public ModelSlimeGolem(final float p_i46362_1_, final float p_i46362_2_) {
        final int i = 128;
        final int j = 128;
    ...
    public void setLivingAnimations(final EntityLivingBase entitylivingbaseIn, final float limbSwing, final float limbSwingAmount, final float partialTickTime) {
        final EntitySlimeGolem EntitySlimeGolem = (EntitySlimeGolem)entitylivingbaseIn;
        final int i = EntitySlimeGolem.getAttackTimer();
        if (i > 0) {
            ...
            final int j = EntitySlimeGolem.getHoldRoseTick();
            if (j > 0) {
