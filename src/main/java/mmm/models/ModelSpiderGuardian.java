...
public class ModelSpiderGuardian extends ModelBase
{
    ...
    public ModelSpiderGuardian() {
        ...
        for (int i = 0; i < this.guardianSpines.length; ++i) {
            (this.guardianSpines[i] = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-1.0f, -4.5f, -1.0f, 2, 9, 2);
            this.guardianBody.addChild(this.guardianSpines[i]);
        }
        (this.guardianEye = new ModelRenderer((ModelBase)this, 8, 0)).addBox(-1.0f, 15.0f, 0.0f, 2, 2, 1);
    ...
    public void setRotationAngles(final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch, final float scaleFactor, final Entity entityIn) {
        final EntitySpiderGuardian EntitySpiderGuardian = (EntitySpiderGuardian)entityIn;
        final float f = ageInTicks - EntitySpiderGuardian.ticksExisted;
        ...
        final float f2 = (1.0f - EntitySpiderGuardian.getSpikesAnimation(f)) * 0.55f;
        for (int i = 0; i < 12; ++i) {
        ...
        if (EntitySpiderGuardian.hasTargetedEntity()) {
            entity = (Entity)EntitySpiderGuardian.getTargetedEntity();
        }
        if (entity != null) {
            ...
            if (d0 > 0.0) {
                ...
                this.spiderLeg5.rotateAngleY = 0.0f;
                this.spiderLeg6.rotateAngleY = 0.0f;
                this.spiderLeg7.rotateAngleY = 0.0f;
                this.spiderLeg8.rotateAngleY = 0.0f;
            }
            else {
                this.guardianEye.rotationPointY = 1.0f;
                this.spiderLeg1.rotateAngleY = 1.0f;
                this.spiderLeg2.rotateAngleY = 1.0f;
                this.spiderLeg3.rotateAngleY = 1.0f;
                this.spiderLeg4.rotateAngleY = 1.0f;
                this.spiderLeg5.rotateAngleY = 1.0f;
                this.spiderLeg6.rotateAngleY = 1.0f;
                this.spiderLeg7.rotateAngleY = 1.0f;
                this.spiderLeg8.rotateAngleY = 1.0f;
            }
