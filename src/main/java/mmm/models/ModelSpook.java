...
public class ModelSpook extends ModelBiped
{
    ...
    public ModelRenderer biped2RightArm;
    public ModelRenderer biped2LeftArm;
    
    public ModelSpook() {
        this(0.0f, false);
    }
    
    public ModelSpook(final float modelSize, final boolean p_i1168_2_) {
        ...
        (this.biped2RightArm = new ModelRenderer((ModelBase)this, 40, 16)).addBox(-3.0f, -2.0f, 0.0f, 4, 12, 4, modelSize);
        this.biped2RightArm.setRotationPoint(-5.0f, 3.0f, 0.0f);
        this.biped2LeftArm = new ModelRenderer((ModelBase)this, 40, 16);
        this.biped2LeftArm.mirror = true;
        this.biped2LeftArm.addBox(-1.0f, -2.0f, 0.0f, 4, 12, 4, modelSize);
        this.biped2LeftArm.setRotationPoint(5.0f, 3.0f, 0.0f);
    }
    ...
    public void render(final Entity entityIn, final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch, final float scale) {
        ...
        this.biped2RightArm.render(scale);
        this.biped2LeftArm.render(scale);
        if (this.isChild) {
            final float f = 2.0f;
    ...
    public void setRotationAngles(final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch, final float scaleFactor, final Entity entityIn) {
        ...
        this.biped2RightArm.rotationPointZ = 0.0f;
        this.biped2RightArm.rotationPointX = -5.0f;
        this.biped2LeftArm.rotationPointZ = 0.0f;
        this.biped2LeftArm.rotationPointX = 5.0f;
        ...
        this.biped2RightArm.rotateAngleX = MathHelper.cos(limbSwing * 0.6662f + 3.1415927f) * 2.0f * limbSwingAmount * 0.5f / f;
        this.biped2LeftArm.rotateAngleX = MathHelper.cos(limbSwing * 0.6662f) * 2.0f * limbSwingAmount * 0.5f / f;
        this.biped2RightArm.rotateAngleZ = 0.0f;
        this.biped2LeftArm.rotateAngleZ = 0.0f;
    }
}
