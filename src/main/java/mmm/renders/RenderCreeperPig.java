...
public class RenderCreeperPig extends RenderLiving<EntityCreeperPig>
{
    ...
    protected int getColorMultiplier(final EntityCreeperPig entitylivingbaseIn, final float lightBrightness, final float partialTickTime) {
    ...
    protected ResourceLocation getEntityTexture(final EntityCreeperPig entity) {
        return RenderCreeperPig.PIG_TEXTURES;
    }
    
    static {
        PIG_TEXTURES = new ResourceLocation("mmm:textures/model/creeper_pig.png");
    }
}
