...
public class RenderElderSpiderGuardian extends RenderLiving<EntityElderSpiderGuardian>
{
    private static final ResourceLocation GUARDIAN_TEXTURE;
    private static final ResourceLocation GUARDIAN_BEAM_TEXTURE;
    
    public RenderElderSpiderGuardian(final RenderManager renderManagerIn) {
        super(renderManagerIn, new ModelElderSpiderGuardian(), 0.5f);
    }
    
    public boolean shouldRender(final EntityElderSpiderGuardian livingEntity, final ICamera camera, final double camX, final double camY, final double camZ) {
    ...
    public void doRender(final EntityElderSpiderGuardian entity, final double x, final double y, final double z, final float entityYaw, final float partialTicks) {
        ...
        if (entitylivingbase != null) {
            ...
            this.bindTexture(RenderElderSpiderGuardian.GUARDIAN_BEAM_TEXTURE);
            ...
            final Vec3d vec3d2 = this.getPosition((EntityLivingBase)entity, f5, partialTicks);
    ...
    protected void preRenderCallback(final EntityElderSpiderGuardian entitylivingbaseIn, final float partialTickTime) {
        GlStateManager.scale(2.0f, 2.0f, 2.0f);
    }
    
    protected ResourceLocation getEntityTexture(final EntityElderSpiderGuardian entity) {
        return RenderElderSpiderGuardian.GUARDIAN_TEXTURE;
    }
    
    static {
        GUARDIAN_TEXTURE = new ResourceLocation("mmm:textures/model/elderspider_guardian.png");
        GUARDIAN_BEAM_TEXTURE = new ResourceLocation("mmm:textures/model/guardian_beam.png");
    }
}
