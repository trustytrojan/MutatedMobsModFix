...
public class RenderGuardianGolem extends RenderLiving<EntityGuardianGolem>
{
    ...
    protected ResourceLocation getEntityTexture(final EntityGuardianGolem entity) {
        return RenderGuardianGolem.IRON_GOLEM_TEXTURES;
    }
    ...
    public void doRender(final EntityGuardianGolem entity, final double x, final double y, final double z, final float entityYaw, final float partialTicks) {
        ...
        if (entitylivingbase != null) {
            ...
            this.bindTexture(RenderGuardianGolem.GUARDIAN_BEAM_TEXTURE);
    ...
    protected void applyRotations(final EntityGuardianGolem entityLiving, final float ageInTicks, final float rotationYaw, final float partialTicks) {
    ...
    static {
        IRON_GOLEM_TEXTURES = new ResourceLocation("mmm:textures/model/guardian_golem.png");
