...
public class RenderShulkerFireball extends Render<EntityShulkerFireball>
{
    private static final ResourceLocation SHULKER_SPARK_TEXTURE;
    private final ModelShulkerBullet model;
    
    public RenderShulkerFireball(final RenderManager manager) {
        super(manager);
    ...
    public void doRender(final EntityShulkerFireball entity, final double x, final double y, final double z, final float entityYaw, final float partialTicks) {
    ...
    protected ResourceLocation getEntityTexture(final EntityShulkerFireball entity) {
        return RenderShulkerFireball.SHULKER_SPARK_TEXTURE;
    }
    
    static {
        SHULKER_SPARK_TEXTURE = new ResourceLocation("mmm:textures/model/spark.png");
    }
}
