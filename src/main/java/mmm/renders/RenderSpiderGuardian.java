...
public class RenderSpiderGuardian extends RenderLiving<EntitySpiderGuardian>
{
    private static final ResourceLocation GUARDIAN_TEXTURE;
    private static final ResourceLocation GUARDIAN_BEAM_TEXTURE;
    
    public RenderSpiderGuardian(final RenderManager renderManagerIn) {
        super(renderManagerIn, new ModelSpiderGuardian(), 0.5f);
    }
    
    public boolean shouldRender(final EntitySpiderGuardian livingEntity, final ICamera camera, final double camX, final double camY, final double camZ) {
    ...
    public void doRender(final EntitySpiderGuardian entity, final double x, final double y, final double z, final float entityYaw, final float partialTicks) {
        ...
        if (entitylivingbase != null) {
            ...
            this.bindTexture(RenderSpiderGuardian.GUARDIAN_BEAM_TEXTURE);
    ...
    protected ResourceLocation getEntityTexture(final EntitySpiderGuardian entity) {
        return RenderSpiderGuardian.GUARDIAN_TEXTURE;
    }
    
    static {
        GUARDIAN_TEXTURE = new ResourceLocation("mmm:textures/model/spider_guardian.png");
