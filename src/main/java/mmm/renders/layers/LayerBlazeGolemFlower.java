...
public class LayerBlazeGolemFlower implements LayerRenderer<EntityBlazeGolem>
{
    private final RenderBlazeGolem ironGolemRenderer;
    
    public LayerBlazeGolemFlower(final RenderBlazeGolem ironGolemRendererIn) {
        this.ironGolemRenderer = ironGolemRendererIn;
    }
    
    public void doRenderLayer(final EntityBlazeGolem entitylivingbaseIn, final float limbSwing, final float limbSwingAmount, final float partialTicks, final float ageInTicks, final float netHeadYaw, final float headPitch, final float scale) {
