...
public class LayerCreeperGolemCharge implements LayerRenderer<EntityCreeperGolem>
{
    private static final ResourceLocation LIGHTNING_TEXTURE;
    private final RenderCreeperGolem creeperRenderer;
    private final ModelCreeperGolem creeperModel;
    
    public LayerCreeperGolemCharge(final RenderCreeperGolem creeperRendererIn) {
        this.creeperModel = new ModelCreeperGolem(2.0f);
    ...
    public void doRenderLayer(final EntityCreeperGolem entitylivingbaseIn, final float limbSwing, final float limbSwingAmount, final float partialTicks, final float ageInTicks, final float netHeadYaw, final float headPitch, final float scale) {
        if (entitylivingbaseIn.getPowered()) {
            ...
            this.creeperRenderer.bindTexture(LayerCreeperGolemCharge.LIGHTNING_TEXTURE);
    ...
    static {
        LIGHTNING_TEXTURE = new ResourceLocation("mmm:textures/model/creepergolem_armor.png");
    }
}
