...
public class LayerGuardianGolemFlower implements LayerRenderer<EntityGuardianGolem>
{
    private final RenderGuardianGolem ironGolemRenderer;
    
    public LayerGuardianGolemFlower(final RenderGuardianGolem ironGolemRendererIn) {
        this.ironGolemRenderer = ironGolemRendererIn;
    }
    
    public void doRenderLayer(final EntityGuardianGolem entitylivingbaseIn, final float limbSwing, final float limbSwingAmount, final float partialTicks, final float ageInTicks, final float netHeadYaw, final float headPitch, final float scale) {
