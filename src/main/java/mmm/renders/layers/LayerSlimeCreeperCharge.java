...
public class LayerSlimeCreeperCharge implements LayerRenderer<EntitySlimeCreeper>
{
    private static final ResourceLocation LIGHTNING_TEXTURE;
    private final RenderSlimeCreeper creeperRenderer;
    private final ModelCreeper creeperModel;
    
    public LayerSlimeCreeperCharge(final RenderSlimeCreeper creeperRendererIn) {
    ...
    public void doRenderLayer(final EntitySlimeCreeper entitylivingbaseIn, final float limbSwing, final float limbSwingAmount, final float partialTicks, final float ageInTicks, final float netHeadYaw, final float headPitch, final float scale) {
        if (entitylivingbaseIn.getPowered()) {
            ...
            this.creeperRenderer.bindTexture(LayerSlimeCreeperCharge.LIGHTNING_TEXTURE);
    ...
    static {
        LIGHTNING_TEXTURE = new ResourceLocation("mmm:textures/model/slime_armor.png");
    }
}
