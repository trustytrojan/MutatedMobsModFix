...
public class LayerSlimeGolemFlower implements LayerRenderer<EntitySlimeGolem>
{
    private final RenderSlimeGolem ironGolemRenderer;
    
    public LayerSlimeGolemFlower(final RenderSlimeGolem ironGolemRendererIn) {
        this.ironGolemRenderer = ironGolemRendererIn;
    }
    
    public void doRenderLayer(final EntitySlimeGolem entitylivingbaseIn, final float limbSwing, final float limbSwingAmount, final float partialTicks, final float ageInTicks, final float netHeadYaw, final float headPitch, final float scale) {
